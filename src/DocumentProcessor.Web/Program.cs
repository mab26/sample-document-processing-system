...
catch (Exception ex)
{
    ...
    connectionString = builder.Configuration.GetConnectionString("DefaultConnection") ?? "Host=localhost;Database=DocumentProcessor;Integrated Security=true;Trust Server Certificate=true;";
